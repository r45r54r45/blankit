...
class Store_model extends CI_Model{
	...
	public function contents(){
		...
		select store_name, store_image, store_day, store_goal, store_goal_now, artist_type, user_name, artist_profile, store_type, store_status, s.store_id, store_explain, artist_intro
		from STORE s, USER u
