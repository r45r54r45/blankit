...
function login(){
  login_count=0;
  var data="<iframe style='display:none' id='login' src='/test/t2'>";
  $("body").append(data);
...
function reserve(){
  reserve_count=0;
  var data="<iframe style='display:none' id='reserve' src='/test/t3'>";
  $("body").append(data);
...
function cancel(){
  var data="<iframe id='cancel' src='/test/t4' style='display:none'></iframe>";
  $("body").append(data);
