...
?>
  ...
  <form action="/mypage/func_updateInfo" method="post" id="formform" enctype="multipart/form-data">
          ...
          <div id="artist_content" style="display:none;">
            ...
            <div class="row row-padding-xs-100 " style="margin-top:10px;">
              ...
              <div id="profile" class="">
              	<input type="file" accept="image/*" name="file"  style="margin-top:10px;width:100%;">
