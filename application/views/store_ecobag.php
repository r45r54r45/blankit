...
<script>
  ...
  <div class="banner">
    ...
    <div class="banner-text">
      <p>오로지 블랭킷에서만, <br class="visible-xs">오로지 이 기간동안에만 만나볼 수 있는</p>
...
<div class="container" >
  <div class="row" style="margin-bottom:40px;">
    <div class="col-md-12" style="  margin-top: 30px;position:relative; height:25px; border-bottom: 1.5px solid #D3D3D3;">
      <div class="menu">
        <a href="/funding"><div class="menu_item">전체</div></a>
        <a href="/funding/cloth"><div class="menu_item">의류</div></a>
        <a href="/funding/ecobag"><div class="menu_item" style="border-bottom:2px solid #96AFB5; color:#96AFB5;">에코백</div></a>
