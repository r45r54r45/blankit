...
<p>회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.</p>
  ...
  <div id="usage_see_content" class="row row-padding-xs-100 " style="display:none; margin-top:10px;">
    <div style="background:#F5F6F7; width:100%; height:130px; overflow-y:auto; padding:5px;">
      제1조(목적)
이 약관은 블랭킷(전자상거래 사업자)(이)가 운영하는 블랭킷(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」
제2조(정의)
① "몰" 이란 블랭킷(이)가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
제14조(환급)
"몰"은 이용자가 구매신청한 재화가 목표 수량 미도달 등의 사유로 인도 또는 제공을 할 수 없을 때에는 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 7영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.
제15조(청약철회 등)
...
④ “몰”에 기재된 음란성, 비방성, 표절 컨텐츠로 인한 금전적 책임과 법적 책임은 해당 게시물을 올린 이에게 있습니다.
